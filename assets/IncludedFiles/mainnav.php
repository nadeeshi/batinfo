<nav class="navbar navbar-inverse navbar-fixed-top" style="background-color: #4c4743;">
	<div class="container-fluid">
      ...
      <a class="navbar-brand" href="#"><span style="font-family: 'Chewy', cursive;
            font-size: 45px; color:#ffffff;" >Bats</span><span style="font-size: 40px;
             color:#ffffff;">Info</span></a>
          ...
          <ul class="nav navbar-nav navbar-right" style="font-size: 16px; padding-top: 1px; padding-bottom: 8px;">
      			...
      			<li><a href="../../controller/login/page1_form.php" id="myBtn" style="font-size: 16px; color:#ffffff;"><span class="glyphicon glyphicon-user"></span> Register</a></li>
            <li><a href="../../controller/login/login.php" id="myBtn" style="font-size: 16px; color:#ffffff;"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
