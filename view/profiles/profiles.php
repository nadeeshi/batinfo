					...
					<div class="col-md-12">
						<div class="ad">      
                            <div class="row">
                                ...
                                <div class="col-md-3">
									<div class="x">
										<a class="aidanews2_img1" href=<?php echo "'../batmap/distribution_c.php?batid=".$id[($f*4)+$j]."'"; ?>>
										...
										<a href=<?php echo "'../batmap/distribution_c.php?batid=".$id[($f*4)+$j]."'"; ?>><?php echo $caption[($f*4)+$j]; ?></a>
										</p>
									</div>
								</div>
