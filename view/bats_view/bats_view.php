    ...
    <body>
        ...
        <div class="col-sm-10 col-sm-push-2 col-xs-12 insert-form">
            ...
            <div class="table" >
                ...
                <table >
                    <thead>
                        <tr>
                            ...
                            <td class='td th_option lbl head'>View</td>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo '<td class="td_data td_data_op lbl"><a class="link" href="view.php?id=' . $row['scientific_name'] . '" "><span class="glyphicon_my glyphicon glyphicon-play"></span></a></td>';
                ...
                <div class="col-xs-8 edit-del-button">


                    <button onclick="window.location.href = '../insert/insert_form.php'" class="insert-link my-buttons " id ="myBtn">Insert</button>
                    <button onclick="window.location.href = '../delete_update/edit_delete_home.php'" class="insert-link my-buttons " id ="myBtn">Edit</button>
                    <button onclick="window.location.href = '../delete_update/edit_delete_home.php'" class="insert-link my-buttons " id ="myBtn">Delete</button>
